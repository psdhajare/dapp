...
SYSTEM_PROMPT = (
    ...
    "If only an annual %/p.a. is given, use it directly. If a RANGE is given "
    "(e.g. 'up to 3.5% per month' or '0.75%–3.5% monthly'), use the highest "
    "standard rate (the rate a normal revolving balance incurs). foreign_tx_fee = percent "
    ...
    "For network give the card's payment scheme, one of: visa, mastercard, "
    "amex, rupay, diners, discover, unionpay, jcb, other. If the document "
    "doesn't state it, use your knowledge of this specific card's actual "
    "scheme; only use 'other' if you genuinely don't know. "
